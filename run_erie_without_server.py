...
if __name__ == "__main__":
    ...
    #commuter_file = "data/erie/work_population_sample_1000.shp.zip"
    # commuter_file = "data/erie/population/work_population_sample_10k.shp.zip"
    commuter_file = "data/erie/population/erie_population_2020.csv"
